...
import { supabase } from '../lib/supabaseClient';
import type { Course } from '../types';
import { sendApplicationEmail } from '../utils/emails';
...
export default function ApplicationFormModal({ course, onClose }: ApplicationFormModalProps) {
  ...
  //     console.log('Documents before inserting:', documents);
  ...
  //       if (documentsError) {
  //         console.error('Error inserting application documents:', documentsError.message);
  //         throw documentsError;
  //       }
  //     } else {
  //       console.warn('No documents uploaded, skipping insert.');
  //     }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <input type="file" name="academics" onChange={handleFileChange} required />
            </div>
            ...
            <div>
              ...
              <input type="file" name="recommendationLetter1" onChange={handleFileChange} required />
            </div>
            ...
            <div>
              ...
              <input type="file" name="recommendationLetter2" onChange={handleFileChange} required />
            </div>
            ...
            <div>
              ...
              <input type="file" name="experienceLetter" onChange={handleFileChange} />
            </div>
          ...
          <button type="submit" disabled={loading || success} className="w-full py-2 px-4 bg-blue-600 text-white rounded-md">
            {loading ? 'Submitting...' : success ? 'Submitted!' : 'Submit Application'}
          </button>
        </form>
      </div>
